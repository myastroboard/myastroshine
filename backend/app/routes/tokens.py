...
from app.dependencies import TokenServiceDep
...
async def list_tokens(tokens: TokenServiceDep) -> TokenListResponse:
...
async def create_token(
    request: CreateTokenRequest, tokens: TokenServiceDep
) -> CreatedTokenResponse:
...
async def revoke_token(token_id: str, tokens: TokenServiceDep) -> None:
